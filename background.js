...
// // Handle the API client load
// function handleClientLoad() {
//   gapi.load('client:auth2', initializeGoogleClassroomApi);
// }
...
// Message listener to retrieve deadlines
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
  if (message.action === 'getDeadlines') {
    // Fetch the deadlines here and send the response
    const deadlines = [{courseTitle:"Title 1", workTitle:"work 1", deadline:"Today"},{courseTitle:"Title 1", workTitle:"work 1", deadline:"Today"},{courseTitle:"Title 1", workTitle:"work 1", deadline:"Today"}]; // Replace with your implementation to fetch deadlines
